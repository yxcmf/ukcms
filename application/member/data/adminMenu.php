        ...
        'children' => [
            ['title' => '账户管理', 'icon' => 'fa fa-users', 'url_value' => '', 'ifvisible' => 1, 'orders' => 1,
                'children' => [
                    ...
                    ['title' => '会员权限', 'icon' => 'fa fa-address-card', 'url_value' => 'member/admin.group/index', 'ifvisible' => 1, 'orders' => 2,
                       'children' => [
                            ['title' => '添加会员分组', 'icon' => 'fa fa-plus', 'url_value' => 'member/admin.group/add', 'ifvisible' => 0, 'orders' => 2],
                            ['title' => '编辑会员分组', 'icon' => 'fa fa-edit', 'url_value' => 'member/admin.group/edit', 'ifvisible' => 0, 'orders' => 3],
                            ['title' => '会员分组状态', 'icon' => 'fa fa-toggle-on', 'url_value' => 'member/admin.group/setstate', 'ifvisible' => 0, 'orders' => 4],
                            ['title' => '删除会员分组', 'icon' => 'fa fa-times', 'url_value' => 'member/admin.group/delete', 'ifvisible' => 0, 'orders' => 5]
                        ]
                    ],
                ]
            ]
