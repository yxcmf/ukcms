...
INSERT INTO `uk_admin_menu` VALUES ('69', '35', '广告管理', 'fa fa-photo', '1', '', '_self', '1497771040', '1514013308', '3', '0', '1');
...
-- ----------------------------
INSERT INTO `uk_admin_user` VALUES ('1', '1', '<account>', '路过', '<password>', '1', '13638816362', '404133748@qq.com', '1491880778', '1513322869', '127.0.0.1', '0', '1');
...
INSERT INTO `uk_article` VALUES ('2', 'frontbase', '0', '1', ',', 'JavaScript语言简介', '1500103276', '1502097983', '100', '1', '0', '原创', 'JavaScript是一种属于网络的脚本语言,已经被广泛用于Web应用开发', '4', '直译式脚本语言,跨平台性');
...
INSERT INTO `uk_article` VALUES ('6', 'newframe', '0', '1', ',', 'React', '1500107255', '1502096594', '100', '1', '0', '原创', 'React 起源于 Facebook 的内部项目，用来架设 Instagram 的网站', '8', '虚拟DOM,组件化,独立封装');
...
INSERT INTO `uk_article` VALUES ('11', 'php', '0', '1', ',', 'Symfony老牌的php框架', '1500110783', '1502094844', '100', '1', '0', '原创', 'Symfony是一个基于MVC模式的面向对象的PHP5框架', '0', '解决方案,团体支持,成熟的前端');
...
CREATE TABLE `uk_model_field` (
  ...
  `status` tinyint(2) unsigned NOT NULL DEFAULT '0' COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=105 DEFAULT CHARSET=utf8 COMMENT='模型字段表';
...
INSERT INTO `uk_model_field` VALUES ('16', '2', 'title', '标题', 'text', 'varchar(256) NOT NULL', '', '', '', '', '1', '1', '1', '1', '0', '1500017779', '1500017779', '101', '1');
