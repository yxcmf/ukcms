...
CREATE TABLE `uk_admin_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=142 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='后台菜单表';
...
INSERT INTO `uk_admin_menu` VALUES	('140', '36', '模型数据图表', 'fa fa-bar-chart-o', '1', 'admin/model/chartdata', '_self', '1541556681', '1541556732', '17', '0', '0');
INSERT INTO `uk_admin_menu` VALUES	('141', '36', '模型图表设置', 'fa fa-wrench', '1', 'admin/model/setchart', '_self', '1541556681', '1541556732', '18', '0', '0');
-- ----------------------------
...
CREATE TABLE `uk_link` (
  ...
  `content` varchar(7000) NOT NULL DEFAULT '' COMMENT '描述',
...
CREATE TABLE `uk_link_group` (
  ...
  PRIMARY KEY (`id`),
  KEY `id` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='广告位分组表 ';
